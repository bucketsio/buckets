...
module.exports = (grunt) ->
  grunt.initConfig
    ...
    shell:
      ...
      cov:
        command: 'NODE_ENV=test ./node_modules/.bin/mocha --compilers coffee:coffee-script/register --recursive test/server --require blanket --reporter html-cov > coverage.html'
